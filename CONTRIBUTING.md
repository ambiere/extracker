...
Thank you for considering contributing to the development of the extracker microservice API!
...
There are several ways you can contribute to the extracker microservice API:
...
1. **Fork the Repository**: Fork the extracker microservice API repository to your GitHub account.
...
By contributing to the extracker microservice API, you agree that your contributions will be licensed under the [MIT](LICENSE) license.
