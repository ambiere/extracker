...
module.exports = function errorHandler(error, req, res, next) {
  ...
  const isExercieNotFoundError = error.code === "EX_NOT_FOUND";
  ...
  if (isExercieNotFoundError) ErrorUtil.handleExerciseNotFoundError(error, res);
...
const ErrorUtil = {
  ...
  handleExerciseNotFoundError: (error, res) => {
